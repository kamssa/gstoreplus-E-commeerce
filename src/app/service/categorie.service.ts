...
// observables streams
  ...
  getAllCategorie(): Observable<Resultat<Categorie[]>> {
    return this.http.get<Resultat<Categorie[]>>(`${environment.apiUrl}/categories`);
  }
  ...
  ajoutCategorie(categorie: Categorie): Observable<Resultat<Categorie>> {
    ...
    return this.http.post<Resultat<Categorie>>(`${environment.apiUrl}/categories`, categorie);
  }
  modifCategorie(categorie: Categorie): Observable<Resultat<Categorie>> {
    ...
    return this.http.put<Resultat<Categorie>>(`${environment.apiUrl}/categories`, categorie);
  }
  getCategorieById(id: Categorie): Observable<Resultat<Categorie>> {
    return this.http.get<Resultat<Categorie>>(`${environment.apiUrl}/categories/${id}`);
  }
